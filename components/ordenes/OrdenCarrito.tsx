...
type OrdenCarritoProps = {
  order: OrderConProductos;
};
export default function OrdenCarrito({ order }: OrdenCarritoProps) {
  return (
    <section
    ...
    >
      ...
      <dl className="mt-6 space-y-4">
        {order.orderProducts.map((product) => (
          <div
            key={product.id}
            className="flex items-center border-t pt-4 gap-2 border-amber-300"
          >
